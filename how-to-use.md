...
{% include how_to_use_video.html url="https://www.youtube.com/embed/N40jSfghVqM?si=5TlMPBbKa4594_Pk" title="How to install" description="Installing is simpler than making instant noodles.<br/><br/> Just jump over to the Chrome Web Store and search for 'Profile Jumper!' - it's easier to find than your keys in the morning.<br/><br/> Or, if you love easiness (it's my mission too), just click this <a href='https://chrome.google.com/webstore/detail/profile-jumper-jump-betwe/fgjjcaimpepmohgbbeaooecldlknlkef' target='_blank' rel='noopener noreferrer'>handy link to the Chrome Web Store</a> provided.<br/><br/> It's so convenient, you’ll wonder if this 'how to' has psychic powers!" %}
